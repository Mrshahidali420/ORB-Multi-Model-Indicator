...
A local MCP server that lets Claude Code generate and edit images through your **existing web-based accounts** (ChatGPT web, Google Gemini web) — no paid image-generation APIs required.

> **Name**: "Pixel Bridge" — it *bridges* Claude Code to your web image-gen accounts through a real browser. (Working title was "Web Image Generation MCP"; alternates considered: `browsergen-mcp`, `canvas-courier`.)
